...
public class ApiFileFormatter extends Formatter implements IFormatter {
    ...
    public void format(FormatterArgs args) {
        ...
        try {
            template = fileReaderUtil.read(FileEnum.API.templateFilename);
        } catch (IOException e) {
        ...
        String path = String.format(FileEnum.API.outputFilepathFormat, args.getOutputDir(), args.getPackageName(), args.getPascalName());
    ...
    public static void main(String[] args) {
        ...
        new ApiFileFormatter().format(formatterArgs);
