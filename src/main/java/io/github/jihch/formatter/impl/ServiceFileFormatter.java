...
public class ServiceFileFormatter extends Formatter implements IFormatter {
    ...
    public void format(FormatterArgs args) {
        ...
        try {
            template = fileReaderUtil.read(FileEnum.SERVICE.templateFilename);
        } catch (IOException e) {
        ...
        String path = String.format(FileEnum.SERVICE.outputFilepathFormat, args.getOutputDir(), args.getPackageName(), args.getPascalName());
    ...
    public static void main(String[] args) {
        ...
        new ServiceFileFormatter().format(formatterArgs);
